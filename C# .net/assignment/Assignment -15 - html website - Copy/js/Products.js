...
// if product array is not in local storege then uploading it
if(!localStorage.getItem("productsData")){
    localStorage.setItem("productsData", JSON.stringify(productsData));
}

// function to display the products in ui
...
// adding event listener change the filter the product array and call
// displayproduct then passing the array as the argument to display filtered list

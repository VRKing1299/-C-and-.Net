...
<body>
    <h1>Billing Master</h1>
        <div class="navDiv">
            ...
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/CustomerMaster.aspx">Customer Manager</asp:HyperLink>
            <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/BooksMaster.aspx">Booking Manager</asp:HyperLink>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/BillingMaster.aspx" ForeColor="#FF3399" Font-Underline="True">Billing</asp:HyperLink>
    ...
    <div>
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:DropDownList ID="CustomerPhNoDropDown" runat="server" OnSelectedIndexChanged="CustomerPhNoDropDown_SelectedIndexChanged" AutoPostBack="True">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
...
&nbsp;</td>
        ...
        <br /> <br />
    <div>
        <asp:GridView ID="gvBooksData" runat="server" Visible="False">
        </asp:GridView>
    </div>
    </form>

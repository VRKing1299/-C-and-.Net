    ...
    export class BasicPrograms {
      ...
      addNumbers(): void {
        ...
        try {
          ...
          if (
            typescriptExample.isValid(num1) &&
            ...
            //Display Alert
            typescriptExample.showMessage(
              "Sum of the two numbers is: " + sumResult
            );
      ...
      throwError(functionNameParam: string, error: any) {
        ...
        try {
          ...
          //Show Error Message
          typescriptExample.showMessage(
            functionName + " Error: " + (error.description || error.message)
          );
        }
      }
